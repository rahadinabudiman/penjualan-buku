								...
								<div class="tab-pane fade show active" id="man" role="tabpanel">
									<div class="tab-single">
                                        ...
                                        <?php
                                            ...
                                            while($databuku = $data->fetch_assoc()){
                                        ?>
										...
										<div class="row">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.html">
															<img class="default-img" src="admin/foto_buku/132033499_241037497393694_6263766216181779112_o.jpg" width="550" height="750">
															<img class="hover-img" src="admin/foto_buku/132033499_241037497393694_6263766216181779112_o.jpg" width="550" height="750">
														</a>
														<div class="button-head">
															<div class="product-action">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													<div class="product-img">
														<a href="product-details.html">
															<img class="default-img" src="admin/foto_buku/133467997_419079602857725_4194639166511059973_n.jpg" alt="#">
															<img class="hover-img" src="admin/foto_buku/133467997_419079602857725_4194639166511059973_n.jpg" alt="#">
														</a>
														<div class="button-head">
															<div class="product-action">
																<a data-toggle="modal" data-target="#exampleModal" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
